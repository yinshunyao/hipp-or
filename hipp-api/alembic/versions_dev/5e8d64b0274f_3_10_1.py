...
Revision ID: 5e8d64b0274f
Revises: f7a91b2c3d4e
Create Date: 2026-03-23 15:32:51.507453
...
revision = '5e8d64b0274f'
down_revision = 'f7a91b2c3d4e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('vadmin_chat_message', 'update_datetime',
               ...
               existing_comment='更新时间',
               existing_nullable=False)
    # 禁止 drop_index：外键会占用同列索引，MySQL 1553。仅 alter_column 即可。
