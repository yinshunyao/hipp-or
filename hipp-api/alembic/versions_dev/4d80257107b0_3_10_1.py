...
Revision ID: 4d80257107b0
Revises: a1b2c3d4e5f6
Create Date: 2026-03-26 17:23:37.766454
...
def upgrade():
    ...
    op.alter_column('vadmin_auth_role', 'update_datetime',
               ...
               existing_comment='更新时间',
               existing_nullable=False)
    op.alter_column('vadmin_auth_user', 'is_system_created',
               existing_type=mysql.TINYINT(display_width=1),
               comment='是否由系统/后台创建（多标签「系统创建」）',
               existing_comment='是否由系统/后台创建（用于多标签「系统创建」）',
               existing_nullable=False)
...
def downgrade():
    ...
    op.alter_column('vadmin_auth_user', 'is_system_created',
               ...
               existing_comment='是否由系统/后台创建（多标签「系统创建」）',
               existing_nullable=False)
    op.alter_column('vadmin_auth_role', 'update_datetime',
               existing_type=mysql.DATETIME(),
               server_default=sa.text('CURRENT_TIMESTAMP'),
