...
Revision ID: 80492c7c769a
Revises: d4f2a1b3c8e0
Create Date: 2026-03-23 15:30:45.311924
...
revision = '80492c7c769a'
down_revision = 'd4f2a1b3c8e0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('vadmin_chat_message', 'update_datetime',
               ...
               existing_comment='更新时间',
               existing_nullable=False)
    # 不得 drop ix_vadmin_chat_message_session_id：MySQL 外键依赖该索引，drop 会报 1553
    ...
    op.alter_column('vadmin_chat_session', 'update_datetime',
               ...
               existing_comment='更新时间',
               existing_nullable=False)
    # 不得 drop user_id/agent_id 索引：外键约束依赖
