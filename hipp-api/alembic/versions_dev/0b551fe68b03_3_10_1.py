...
Revision ID: 0b551fe68b03
Revises: 5e8d64b0274f
Create Date: 2026-03-23 15:53:14.073794
...
revision = '0b551fe68b03'
down_revision = '5e8d64b0274f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('vadmin_auth_user', 'update_datetime',
               ...
               existing_comment='更新时间',
               existing_nullable=False)
    op.alter_column('vadmin_chat_message', 'session_id',
               existing_type=mysql.INTEGER(),
               comment='会话 vadmin_chat_session.id',
               existing_comment='会话',
               existing_nullable=False)
    ...
    op.alter_column('vadmin_chat_message', 'update_datetime',
               ...
               existing_comment='更新时间',
               existing_nullable=False)
    op.alter_column('vadmin_chat_session', 'user_id',
               existing_type=mysql.INTEGER(),
               comment='用户 vadmin_auth_user.id',
               existing_comment='用户',
               existing_nullable=False)
    op.alter_column('vadmin_chat_session', 'agent_id',
               existing_type=mysql.INTEGER(),
               comment='智能体 vadmin_agent.id',
               existing_comment='智能体',
               existing_nullable=False)
...
def downgrade():
    ...
    op.alter_column('vadmin_chat_session', 'user_id',
               existing_type=mysql.INTEGER(),
               comment='用户',
               existing_comment='用户 vadmin_auth_user.id',
               existing_nullable=False)
    op.alter_column('vadmin_chat_message', 'update_datetime',
               existing_type=mysql.DATETIME(),
               server_default=sa.text('CURRENT_TIMESTAMP'),
    ...
    op.alter_column('vadmin_chat_message', 'session_id',
               existing_type=mysql.INTEGER(),
               comment='会话',
               existing_comment='会话 vadmin_chat_session.id',
               existing_nullable=False)
    op.alter_column('vadmin_auth_user', 'update_datetime',
               existing_type=mysql.DATETIME(),
               server_default=sa.text('CURRENT_TIMESTAMP'),
