...
Revision ID: 8bc64a7f0ebd
Revises: b2c4e6d8a0f1
Create Date: 2026-03-25 15:58:47.369133
...
def upgrade():
    ...
    op.alter_column('vadmin_agent', 'update_datetime',
               ...
               existing_comment='更新时间',
               existing_nullable=False)
    op.create_index(op.f('ix_vadmin_agent_service_type'), 'vadmin_agent', ['service_type'], unique=False)
...
def downgrade():
    ...
    op.alter_column('vadmin_auth_dept', 'create_datetime',
               ...
               existing_comment='创建时间',
               existing_nullable=False)
    op.drop_index(op.f('ix_vadmin_agent_service_type'), table_name='vadmin_agent')
    op.alter_column('vadmin_agent', 'update_datetime',
               existing_type=mysql.DATETIME(),
               server_default=sa.text('CURRENT_TIMESTAMP'),
               existing_comment='更新时间',
